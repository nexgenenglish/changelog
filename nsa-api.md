...
- [NSAAPI-774](https://dyned.myjetbrains.com/youtrack/issue/NSAAPI-774) Check the MT open setting in UD setting for determining the Unit checklist.
...
# 1.14.26 on August 26th, 2024
- [NSAAPI-715](https://dyned.myjetbrains.com/youtrack/issue/NSAAPI-715) student passed CT and got certifate of B1+ by email but CT is unlocked again and ask student to do again (the last level or single level)

# 1.14.25 on August 26th, 2024
- [NSAAPI-714](https://dyned.myjetbrains.com/youtrack/issue/NSAAPI-714) clear cache delay

# 1.14.24 on August 26th, 2024
- [nSO-1427](https://dyned.myjetbrains.com/youtrack/issue/nSO-1427) update query, use index on review CT
- [NSAAPI-712](https://dyned.myjetbrains.com/youtrack/issue/NSAAPI-712) Setting Study "Target Points/Week" for Orgs with more than one course
...
# 1.14.21 on August 18th, 2024
- [NSAAPI-706](https://dyned.myjetbrains.com/youtrack/issue/NSAAPI-706) neoJr+: MyLessons Pre-A1:P2 Unit 1 has a blue circle Error 500
- [NSAAPI-707](https://dyned.myjetbrains.com/youtrack/issue/NSAAPI-707) 500 Internal Server Error Something went wrong - Part 1 - Unit 1 level A1-Part 1

# 1.14.20 on August 18th, 2024
#CT With fullname (handle CT without PT data)

# 1.14.19 on August 18th, 2024
...
# 1.14.16 on August 5th, 2024
- [NSAAPI-702](https://dyned.myjetbrains.com/youtrack/issue/NSAAPI-702) Error student can't take the CT - Exequiel Luciano Cvetkovitch (review lesson)

# 1.14.15 on August 5th, 2024
- [NSAAPI-701](https://dyned.myjetbrains.com/youtrack/issue/NSAAPI-701) When using1@jr.com to log in NSO, when click mylessons, there is an error as following.

# 1.14.14 on July, 2024
- [NSA-4031](https://dyned.myjetbrains.com/youtrack/issue/NSA-4031) neoJr.+ teacher's account (unit name custom)
- prevent students from accessing myLesson neoJr+ from nSa 1.23.x and nSo 1.6.x or earlier apps

# 1.14.13 on July 25th, 2024
- enable log request submit study record

# 1.14.12 on July, 2024
- [NSAAPI-700](https://dyned.myjetbrains.com/youtrack/issue/NSAAPI-700) neoJr.+ Mylessons: two major problems found

# 1.14.11 on July 22nd, 2024
- [NSAAPI-691](https://dyned.myjetbrains.com/youtrack/issue/NSAAPI-691) MyLesson: 3956.4 All lessons are saved (add step 1)
- enable log request income

# 1.14.10 on July 22nd, 2024
- [NSAAPI-691](https://dyned.myjetbrains.com/youtrack/issue/NSAAPI-691) MyLesson: 3956.4 All lessons are saved (set unique lesson)
- [NSAAPI-692](https://dyned.myjetbrains.com/youtrack/issue/NSAAPI-692) MyLesson of neoJrPlus and MyRecodrs (weekly progress)
- [NSAAPI-693](https://dyned.myjetbrains.com/youtrack/issue/NSAAPI-693) MyLessons: 3956.3 Saved Lessons List is not cleared for new unit (current level unit)
- [NSAAPI-695](https://dyned.myjetbrains.com/youtrack/issue/NSAAPI-695) MyLessons: heart anim
- [NSAAPI-696](https://dyned.myjetbrains.com/youtrack/issue/NSAAPI-696) Mylesson can see more than 2 previous level
- [NSAAPI-697](https://dyned.myjetbrains.com/youtrack/issue/NSAAPI-697) MyLessons: Review Lessons Order
- [NSAAPI-698](https://dyned.myjetbrains.com/youtrack/issue/NSAAPI-698) NSA ask student to study the same lesson
- [NSAAPI-699](https://dyned.myjetbrains.com/youtrack/issue/NSAAPI-699) after finishing step10, NSA still ask to study Diane's Schedule

# 1.14.9 on July 15th, 2024
...
# 1.11.7 on March 29th, 2023
- [NSAAPI-554](https://dyned.myjetbrains.com/youtrack/issue/NSAAPI-554) neo grading shows "0" points to a student with points and study hours.
...
# 1.10.4 on August 22nd, 2022 
- [NSAAPI-484](https://dyned.myjetbrains.com/youtrack/issue/NSAAPI-484) Fixed error in "Grade" of neo Grading report.
...
- [NSAAPI-426](https://dyned.myjetbrains.com/youtrack/issue/NSAAPI-426) Fixed issue for last study date that doesn't show the same for students tab and classroom tab.
...
- [NSAAPI-414](https://dyned.myjetbrains.com/youtrack/issue/NSAAPI-414) Fixed the MT lesson code that does not match because of the changes to the latest version.
...
- - [NSAAPI-419](https://dyned.myjetbrains.com/youtrack/issue/NSAAPI-419) Fixed the different last study date in Student and Classes Tab.
...
# 1.9.26 on December 31st, 2021
- [NSAAPI-391](https://dyned.myjetbrains.com/youtrack/issue/NSAAPI-391) Fixed expired organization that still allow student to login on nsa and nso.
