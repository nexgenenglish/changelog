...
- [UD-3841](https://dyned.myjetbrains.com/youtrack/issue/UD-3841) Student Study Records Report is not completing the process to download the file.
- [UD-3949](https://dyned.myjetbrains.com/youtrack/issue/UD-3949) Reports are still processing.
- [UD-3950](https://dyned.myjetbrains.com/youtrack/issue/UD-3950) Student Records report - Processing.
- [UD-4067](https://dyned.myjetbrains.com/youtrack/issue/UD-4067) Student Study Records Report processing.
- [UD-4288](https://dyned.myjetbrains.com/youtrack/issue/UD-4288) Don't allow Org Admin or Teachers to issue use the "Generate Certificate" option.
- [UD-4324](https://dyned.myjetbrains.com/youtrack/issue/UD-4324) MyRecords is in processing - STG Server.
- [UD-4348](https://dyned.myjetbrains.com/youtrack/issue/UD-4348) I use chinaadmin@dyned.com to update organization's password, it failed.
- [UD-4369](https://dyned.myjetbrains.com/youtrack/issue/UD-4369) Add a dropdown menu to select which level data to show in My records page.
- [UD-4371](https://dyned.myjetbrains.com/youtrack/issue/UD-4371) MyRecords Report in process for more than 30 minutes.
- [UD-4386](https://dyned.myjetbrains.com/youtrack/issue/UD-4386) Generate MyRecords: unpack error.
- [UD-4388](https://dyned.myjetbrains.com/youtrack/issue/UD-4388) Bulk change Same XLS filename.
- [UD-4389](https://dyned.myjetbrains.com/youtrack/issue/UD-4389) non-unique id error.
- [UD-4398](https://dyned.myjetbrains.com/youtrack/issue/UD-4398) Failed to issue certificate for an inactive and expired account -deby.muñoz@junkabal.com.
- [UD-4400](https://dyned.myjetbrains.com/youtrack/issue/UD-4400) Make all the values in percentage rounded up for the data percentage in each of the reports (MyRecords).
- [UD-4402](https://dyned.myjetbrains.com/youtrack/issue/UD-4402) Can't unlock CT after 5 failed attempts.
- [UD-4404](https://dyned.myjetbrains.com/youtrack/issue/UD-4404) Error 401 when using Teacher account to tried to Import List-of-Students.
- [UD-4405](https://dyned.myjetbrains.com/youtrack/issue/UD-4405) Error 401 when using the Teacher account to "Change Account”.
- [UD-4466](https://dyned.myjetbrains.com/youtrack/issue/UD-4466) Add optional column in the create Student page.
- [UD-4467](https://dyned.myjetbrains.com/youtrack/issue/UD-4467) Add optional column in edit student page.
- [UD-4468](https://dyned.myjetbrains.com/youtrack/issue/UD-4468) Add optional column for Bulk import student files.
- [UD-4473](https://dyned.myjetbrains.com/youtrack/issue/UD-4473) Popup Menu for wrong menu item.
- [UD-4474](https://dyned.myjetbrains.com/youtrack/issue/UD-4474) Numbers are truncated in PDF file of MyRecords.
- [UD-4490](https://dyned.myjetbrains.com/youtrack/issue/UD-4490) Cancel Create a New Student goes to Test tab.
- [UD-4506](https://dyned.myjetbrains.com/youtrack/issue/UD-4506) Column K ( Student ID) - Bulk import student files - STG
- [UD-4508](https://dyned.myjetbrains.com/youtrack/issue/UD-4508) New info tags remain on screen.
- [UD-4510](https://dyned.myjetbrains.com/youtrack/issue/UD-4510) New info label typos.
- [UD-4513](https://dyned.myjetbrains.com/youtrack/issue/UD-4513) No Generated by and timestamp for Student PT Report.
- [UD-4517](https://dyned.myjetbrains.com/youtrack/issue/UD-4517) Change password users request to ROW server.
- [UD-4524](https://dyned.myjetbrains.com/youtrack/issue/UD-4524) Use same successful message for Student PT Report.
- [UD-4553](https://dyned.myjetbrains.com/youtrack/issue/UD-4553) Differentiate my record page for student with menu type.

# [1.6.21.2] on July 23rd, 2025
- [UD-4489](https://dyned.myjetbrains.com/youtrack/issue/UD-4489) My Record page second to hours conversion is incorrect.
