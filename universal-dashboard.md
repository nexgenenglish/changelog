...
- UD-3926Server error to update certificate -MONICA ALCANTARA PAZ
- UD-3770 CAn't generate certificate ID when the status is passed
- UD-3733 when using create a new student in students Tab and setting expired date, the typed expired date does not work
- UD-3722 using bulk import new students, dashboard can't recoginze start date typed in template--impact
- UD-3712 Remove references to DynEd Scores in neojr+ test reporting and documentation
- UD-3352 New Certification Plan popups: need consistent label and names
- UD-3815 Setting Study "Target Points/Week" for Orgs with more than one course
- UD-3663 Improve error message when adding a student with no email address
- UD-3684 Student summary report disappears after it has been generated
- UD-3774 Add certificate plan column in Student Study Records report
- UD-3784 Request to correct language in UD
- UD-3806 Make the selected plan visible based on the available_on values
- UD-3807 Problem: allocate student to class
- UD-3817 Re: Neo Universal Dashboard sorting issue
- UD-3832 Setting Study "Target Points/Week" affects plan not Class
- UD-3866 neoJr+: new Grading Set PointsHour default value
- UD-3535 There is no status to show Expired organizations
- UD-3851 401 Sorry, you are not authorized to access this page.
- UD-3850 Error 404 with some reports in the reports tab option in the neoD
- UD-3842 500 error when loading a class
- UD-3386 419: Sorry, your session has expired. Please refresh and try again.
- UD-3124 Make the timezone settings for newly created organzation follow the local computer timezone
- UD-3687 neoJr.+: Review through MyLessons (UD)
- UD-3656 Unable to generate Study Records Reports "cURL error 28"- EduTech
- UD-3714 cannot generate the template List-of-Student for change-account
- UD-3697The format of SSO profile related to date is not correct
- UD-3696 The direct-register does not work correct
- UD-3740 Bulk change student account export problem
...
- [UD-1862](https://dyned.myjetbrains.com/youtrack/issue/UD-1862) Fixed grammar issue on the error to Active Student AVTION menu.
...
- [UD-1632](https://dyned.myjetbrains.com/youtrack/issue/UD-1632) - Optimize time for generating student certificates
- [UD-1653](https://dyned.myjetbrains.com/youtrack/issue/UD-1653) - Update stuck process for generate student certificates
...
- [UD-647](https://dyned.myjetbrains.com/youtrack/issue/UD-647) - Changed incorrect students' registration date in Student Summary Report.
...
- [UD-304](https://dyned.myjetbrains.com/youtrack/issue/UD-304) - Fixed 'Seacrhing' issue in the "Tests" and "Students" lists.
- [UD-315](https://dyned.myjetbrains.com/youtrack/issue/UD-315) - Fixed wrong date and time for study records.
- [UD-464](https://dyned.myjetbrains.com/youtrack/issue/UD-464) - Fixed the time to be more localized (based on user time zone).
...
- [UD-386](https://dyned.myjetbrains.com/youtrack/issue/UD-386) - Updated change password location.
- [UD-393](https://dyned.myjetbrains.com/youtrack/issue/UD-393) - Added fullname and change username to email on summary report.
- [UD-441](https://dyned.myjetbrains.com/youtrack/issue/UD-441) - Fixed date format on student certificates list.
- [UD-444](https://dyned.myjetbrains.com/youtrack/issue/UD-444) - Fixed hidden register button.
...
- [UD-388](https://dyned.myjetbrains.com/youtrack/issue/UD-388) - Updated candidate search module.
- [UD-426](https://dyned.myjetbrains.com/youtrack/issue/UD-426) - Display student certificate for cross server.
- [UD-428](https://dyned.myjetbrains.com/youtrack/issue/UD-428) - Fixed issue for can't generate student certificate.
- [UD-431](https://dyned.myjetbrains.com/youtrack/issue/UD-431) - Fixed issue for register student issue on dashboard.
- [UD-433](https://dyned.myjetbrains.com/youtrack/issue/UD-433) - Added onboard flag B2C.
- [UD-434](https://dyned.myjetbrains.com/youtrack/issue/UD-434) - Fixed issue for download certificate menu.
- [UD-435](https://dyned.myjetbrains.com/youtrack/issue/UD-435) - Fixed issue for resend certificate menu.
- [UD-437](https://dyned.myjetbrains.com/youtrack/issue/UD-437) - Fixed onboard issue.
